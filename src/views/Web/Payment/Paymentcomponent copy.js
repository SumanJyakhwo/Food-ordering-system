...
export default function PaymentcomponentCopy() {
              ...
              <span>Saved Payment Methods:</span>
                  ...
                  <CardBody className="p-4">
                    ...
                    <div className="d-flex justify-content-between">
                      ...
                      <i onClick={handleAdd} className="ni ni-bold-down mt-1 ml-2 pr-4" />
                    </div>
                    ...
                    {showPaymentAdd && (
                      <>
                        ...
                        <UncontrolledDropdown style={{ width: '100%' }} direction="down">
                          <DropdownToggle caret color="primary" style={{ width: '58%' }}>
                            {payMethod}
                          </DropdownToggle>
                        ...
                        <Button  className="text-center" color="primary" size="lg">
                          Add card
                        </Button>
